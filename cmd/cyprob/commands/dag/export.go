...
- Documentation and learning`,
  ...
  cyprob dag export --targets 192.168.1.1

  # Export to file
  cyprob dag export --targets 10.0.0.0/24 --output scan.yaml

  # Export with vulnerability checks enabled
  cyprob dag export --targets 192.168.1.1 --vuln --output full-scan.yaml

  # Export as JSON
  cyprob dag export --targets 192.168.1.1 --format json`,
