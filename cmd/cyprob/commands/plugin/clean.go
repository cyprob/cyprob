...
Use --dry-run to preview what would be deleted without actually deleting.`,
  ...
  cyprob plugin clean --older-than 720h

  # Preview what would be deleted
  cyprob plugin clean --older-than 720h --dry-run

  # Clean custom cache directory
  cyprob plugin clean --older-than 168h --cache-dir /custom/path

  # JSON output
  cyprob plugin clean --output json`,
