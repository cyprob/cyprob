...
new or updated plugins to the local cache. By default, it downloads all core plugins.`,
  ...
  cyprob plugin update

  # Update only SSH plugins
  cyprob plugin update --category ssh

  # Dry run to see what would be downloaded
  cyprob plugin update --dry-run

  # Force re-download even if cached
  cyprob plugin update --force

  # Update from specific source
  cyprob plugin update --source official

  # JSON output
  cyprob plugin update --output json`,
