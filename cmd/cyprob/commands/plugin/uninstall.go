...
all plugins in a category, or all plugins at once.`,
  ...
  cyprob plugin uninstall --category ssh

  # Uninstall all plugins
  cyprob plugin uninstall --all

  # Alternative commands (aliases)
  cyprob plugin remove ssh-cve-2024-6387
  cyprob plugin rm ssh-cve-2024-6387

  # JSON output
  cyprob plugin uninstall ssh --output json`,
