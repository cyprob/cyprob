...
import (
	...
	dagCmd "github.com/cyprob/cyprob/cmd/cyprob/commands/dag"
	pluginCmd "github.com/cyprob/cyprob/cmd/cyprob/commands/plugin"
	serverCmd "github.com/cyprob/cyprob/cmd/cyprob/commands/server"
	storageCmd "github.com/cyprob/cyprob/cmd/cyprob/commands/storage"
...
const cliExecutable = "cyprob"

// NewCommand constructs the top-level cyprob CLI command, wiring global flags,
...
func NewCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   cliExecutable,
		Short: "Cyprob is a fast and flexible network scanner",
